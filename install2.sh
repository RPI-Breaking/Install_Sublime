...
sudo nano /etc/schroot/chroot.d/x86_conf
...
sudo schroot -- apt-get --yes install libc6:i386 libstdc++6:i386 libglib2.0-0:i386 libx11-6:i386 libpangocairo-1.0-0:i386 libgtk2.0-0:i386 wget sudo nano
